...
const ProjectModal = React.forwardRef<ModalRef, ProjectModalProps>(({ project }, ref) => {
  ...
  useImperativeHandle(ref, () => ({
    ...
    wrapperRef:
      modalRef.current?.wrapperRef ?? ({ current: null } as React.RefObject<HTMLDivElement | null>),
  }));

  if (!project) return null;

  return (
    <Modal ref={modalRef} title={project.title} foldable>
        ...
        <div className={styles.modal__right}>
          <div className={styles.modal__content}>
            ...
            <div className={styles.modal__contact}>
              ...
              <Button text="Contact us" style="outlined" onClick={handleContactClick} />
            </div>
          </div>
        </div>
      </div>
